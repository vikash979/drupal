...
-->
            ...
            <div class="row m-1">
                <div class="col-md-3 border">
                    <div class="">
                        <div class="justify-content-center pl-1 pt-3">
							...
							<div id="sample-1" style="margin:150px auto; max-width:500px;">
							
								<nav class="myAccordion">
									<h2 class="myAccordion__title">Accordion</h2>
                ...
                <div class="col-md-4 border text-white">
                    ...
                    <p class="p-2">
                        <marquee direction="up" onmouseout="this.setAttribute('scrollamount', 2, 0);" onmouseover="this.setAttribute('scrollamount', 3, 0);">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi suscipit mauris sit amet arcu posuere cursus. Donec tincidunt lorem a laoreet sagittis. Nulla porta sem elit, et faucibus leo tincidunt eu. Maecenas facilisis elementum lobortis.</marquee>
                    </p>
                    </div>
                </div>
            </div>
